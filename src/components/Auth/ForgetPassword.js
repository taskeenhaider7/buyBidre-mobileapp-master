                                            ...
                                            <TouchableOpacity
                                                ...
                                                <View style={{alignSelf: 'center'}}><View>
                                                    {this.state.spinnerShow ?
                                                        ...
                                                        :
                                                        <Text
                                                            style={styles.textStyle}>{this.state.forgetPassword ? "Reset password" : "Sign Up"}</Text>
                                                    }
                                                </View>
                                                </View>
                                            </TouchableOpacity>
                                            ...
                                            <TouchableOpacity
                                                ...
                                                <View style={{alignSelf: 'center'}}><View>
                                                    {this.state.spinnerShow ?
                                                        ...
                                                        :
                                                        <Text
                                                            style={styles.textStyle}>{this.state.forgetPassword ? "Reset password" : "LOGIN AS BUYER"}</Text>
                                                    }
                                                </View>
                                                </View>
                                            </TouchableOpacity>
